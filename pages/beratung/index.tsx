    ...
    return (
        <div className="block container">
            ...
            <div className={styles.helpBlock + ' row'}>
                ...
                <p>
                    Information: Die verschlüsselte Online-Beratung funktioniert nach einem sogenannten Postkastensystem, das nicht mit einer regulären E-Mail-Kommunikation vergleichbar ist. 
                    Zur Wahrung Deiner Anonymität können wir Deine E-Mail-Adressen nicht einsehen, selbst wenn Du diese angibst.
                </p>
                <ul>
                    <li>
                    ...
                    <li>
                        Chat-Termine kannst Du nur buchen, wenn Du eine E-Mail-Adresse angegeben hast. Diese kann auch fiktiv sein, Du erhältst dann allerdings keine Erinnerung an den Termin. Du musst dich in diesem Fall zum gebuchten Zeitpunkt einloggen und den Chat betreten. 
                        Möchtest Du zu einem anderen Zeitpunkt einen Chat mit uns führen, schreib uns gern eine E-Mail.
                    </li>
                </ul>
                <p>
